...
CREATE TABLE velveto_bookings (
    ...
    `cancellation_time` DATETIME DEFAULT NULL COMMENT 'Date and time when cancellation requested',
...
CREATE TABLE velveto_bookings_rooms (
    `id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `booking_id` INT NOT NULL,
...
CREATE TABLE velveto_facilitiy_items (
    ...
    `roomable` BOOLEAN NOT NULL COMMENT 'Whether to display this item in room types'
